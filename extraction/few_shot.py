...
# 目的：
#   1. 讀取 A 模組產出的去脈絡化資料
#   2. 執行 Few-shot Entity / Relation Extraction
#   3. 輸出標準化 triplets JSON 給下游圖譜模組使用
# ============================================================

INPUT_JSONL = "data/output/cleaned_posts_evaluated.jsonl"
OUTPUT_JSON = "output/triplets_few_shot.json"
ERROR_CSV = "output/error_logs_few_shot.csv"
...
# ============================================================
# Few-shot 範例區
# 這裡提供幾個「文本 → triplets」範例，讓模型模仿輸出格式與萃取品質
# ============================================================

FEW_SHOT_EXAMPLES = """
Example 1:
Text:
A squat primarily trains the quadriceps and glutes. Poor hip mobility can increase stress on the lower back during a squat.

Output:
{
  "triplets": [
    {
      "source_post_id": "example_1",
      "head": "squat",
      "relation": "trains",
      "tail": "quadriceps",
      "proposition": "A squat primarily trains the quadriceps."
    },
    {
      "source_post_id": "example_1",
      "head": "squat",
      "relation": "trains",
      "tail": "glutes",
      "proposition": "A squat primarily trains the glutes."
    },
    {
      "source_post_id": "example_1",
      "head": "poor hip mobility",
      "relation": "increases stress on",
      "tail": "lower back",
      "proposition": "Poor hip mobility can increase stress on the lower back during a squat."
    }
  ]
}
...
Example 2:
Text:
The conventional deadlift requires a neutral spine, a straight bar path, and an overhand grip. Kelly demonstrates the conventional deadlift.

Output:
{
  "triplets": [
    {
      "source_post_id": "example_2",
      "head": "conventional deadlift",
      "relation": "requires",
      "tail": "neutral spine",
      "proposition": "The conventional deadlift requires a neutral spine."
    },
    {
      "source_post_id": "example_2",
      "head": "conventional deadlift",
      "relation": "requires",
      "tail": "straight bar path",
      "proposition": "The conventional deadlift requires a straight bar path."
    },
    {
      "source_post_id": "example_2",
      "head": "conventional deadlift",
      "relation": "requires",
      "tail": "overhand grip",
      "proposition": "The conventional deadlift requires an overhand grip."
    },
    {
      "source_post_id": "example_2",
      "head": "Kelly",
      "relation": "demonstrates",
      "tail": "conventional deadlift",
      "proposition": "Kelly demonstrates the conventional deadlift."
    }
  ]
}
...
Example 3:
Text:
A band around the ankle helps proper glute engagement. Leg raises with the leg in front of the body primarily target the TFL instead of the glutes.

Output:
{
  "triplets": [
    {
      "source_post_id": "example_3",
      "head": "band around ankle",
      "relation": "helps",
      "tail": "glute engagement",
      "proposition": "A band around the ankle helps proper glute engagement."
    },
    {
      "source_post_id": "example_3",
      "head": "front-leg leg raises",
      "relation": "target",
      "tail": "TFL",
      "proposition": "Leg raises with the leg in front of the body primarily target the TFL instead of the glutes."
    }
  ]
}
...
Example 4:
Text:
The neck stretch targets the muscle in the front and side of the neck. A person should avoid attempting all exercises in one session. The movement involves bending forward and kicking the leg back.

Output:
{
  "triplets": [
    {
      "source_post_id": "example_4",
      "head": "neck stretch",
      "relation": "targets",
      "tail": "front and side neck muscle",
      "proposition": "The neck stretch targets the muscle in the front and side of the neck."
    }
  ]
}
"""
...
# ============================================================
# Prompt 設計區
# Few-shot：提供範例，讓模型模仿三元組萃取格式
# ============================================================

def format_few_shot_prompt(source_post_id: str, text: str) -> str:
    """
    建立 Few-shot 萃取 Prompt。

    目標：
        讓模型參考範例，從去脈絡化文本中抽取較穩定的 entity-relation triplets。
    """
...
def extract_json_object(raw_text: str) -> Dict[str, Any]:
    ...
    用來處理模型偶爾多輸出的 markdown code fence 或前後說明文字。
    """
...
def process_few_shot_extraction() -> None:
    """
    Few-shot 萃取主流程。
    ...
    流程：
        ...
        3. 呼叫 LLM 進行 few-shot 三元組萃取
        4. 使用 Pydantic 驗證輸出格式
        5. 統一輸出到 triplets_few_shot.json
    """

    print("===== 開始執行 Few-shot Entity / Relation Extraction =====")
    ...
    with open(INPUT_JSONL, "r", encoding="utf-8") as infile:
        for line in infile:
            ...
            try:
                prompt = format_few_shot_prompt(source_post_id, text)
